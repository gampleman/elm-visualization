...
{-| This module shows how to build a simple scatter chart using some of
...
import TypedSvg.Attributes exposing (class, cx, cy, fill, id, offset, opacity, r, stopColor, stopOpacity, stroke, transform, viewBox)
import TypedSvg.Attributes.InPx exposing (strokeWidth)
import TypedSvg.Core exposing (Svg)
import TypedSvg.Types exposing (CoordinateSystem(..), Length(..), Opacity(..), Paint(..), Transform(..), px)
...
circles model =
    List.map transformCoords model
        |> List.map pointCircle
