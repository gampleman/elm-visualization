...
line =
    Visualization.Shape.Generators.line
...
lineRadial curve =
    Visualization.Shape.Generators.line (Curve.toPolarWithCenter ( 0, 0 ) >> curve)
...
area =
    Visualization.Shape.Generators.area
...
areaRadial curve =
    Visualization.Shape.Generators.area (Curve.toPolarWithCenter ( 0, 0 ) >> curve)
